...
const CarDetails = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6">
      ...
      <h1 className="text-4xl font-bold text-center mb-10">{car.carName}</h1>
      ...
      <div className="flex flex-col md:flex-row gap-10">
        ...
        <div className="md:w-1/2 bg-white p-6 rounded-xl shadow-lg space-y-4">
          <p className="text-gray-600"><strong>Seller:</strong> {car.sellerName}</p>
          <p className="text-gray-600"><strong>Email:</strong> {car.sellerEmail}</p>
